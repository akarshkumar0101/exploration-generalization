...
class Node():
    def __init__(self, node_parent, traj, state_sim, obs, latent, depth):
    ...
    def get_full_trajectory(self):
        if self.node_parent is None:
            return self.traj
        return self.node_parent.get_full_trajectory()+self.traj
...
class Archive():
    ...
    def add_node(self, node):
        ...
        if node.node_parent:
            node.node_parent.children.append(node)
    ...
    def remove_node(self, node):
        ...
        if node.node_parent:
            node.node_parent.children.remove(node)
...
class GoExplore():
    ...
    def explore_from(self, node_start):
        ...
        for i in range(self.n_exploration_steps):
            ...
            state_sim_next = self.env_get_state()
